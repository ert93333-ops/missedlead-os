...
export const copy = {
  en: {
    ...
    thinking: 'Reviewing your details…', retry: 'Try again', translate: 'Translate', translationWarning: 'AI translation may be inaccurate. Confirm prices, scope, warranties, and legal terms before approval.', saveTranslation: 'Save translations and continue',
    possible: 'What it might be', provisional: 'These are possibilities. A technician must inspect the problem to confirm its cause.',
  ...
  es: {
    ...
    thinking: 'Revisando sus datos…', retry: 'Intentar de nuevo', translate: 'Traducir', translationWarning: 'La traducción con IA puede contener errores. Confirme precios, alcance, garantías y términos legales antes de aprobar.', saveTranslation: 'Guardar traducciones y continuar',
    possible: 'Qué podría ser', provisional: 'Estas son posibilidades. Un técnico debe inspeccionar el problema para confirmar la causa.',
